  ...
  return (
    <div className={cn(`top-0 left-0 w-full h-full bg-black/80 z-30 flex justify-center items-center flex-col`, val === false ? 'hidden' : 'fixed')}>
      <form
        ...
        className={`rounded flex flex-col gap-2 border-2 border-white p-5 w-2/3 h-[60vh] justify-between text-center`}
      >
        ...
        <textarea rows={10} name={'lyric'} className={`p-2 rounded text-black w-full`} placeholder={'Lyrics'}/>
